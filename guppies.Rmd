...
model1.1 <- MCMCglmm(orange ~ 1 + het + site , random = ~gen, ginverse = list(gen = Ginv.1), data = as.data.frame(pheno), prior = prior1.1, family = "gaussian", nitt = 100000, burnin = 3000, verbose = F)
```
